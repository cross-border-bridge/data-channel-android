...
function OnSendButtonClick1() {
    ...
    channel.send("PUSH-FROM-JS (DO NOT REPLY)", undefined);
}
...
function OnSendButtonClick2() {
    ...
    channel.send("REQUEST-FROM-JS (NEED REPLY)", function(error, packet) {
        if (error) {
            ...
            var text = "received result from Java: packet=" + packet;
            console.log(text);
